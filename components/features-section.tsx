  ...
  const features = [
    {
      ...
      description: 'Taman bermain anak, lapangan olahraga, area bersantai, dan taman hijau yang luas untuk menghemat waktu berkualitas bersama keluarga.',
      number: '01',
    },
    {
      icon: Shield,
    ...
    },
    {
      ...
      description: 'Bangunan tahan gempa, sistem drainase optimal dan bebas banjir, listrik stabil, dan akses jalan yang lebar dan kokoh.',
      number: '03',
    },
    {
      icon: TrendingUp,
    ...
    },
    {
      ...
      description: 'Proses approval cepat, cicilan ringan, berbagai pilihan bank mitra, dan tim profesional siap membantu.',
      number: '06',
    },
  ]
